/**
 * macOS: `configure` / `isConfigured` for the macFUSE kernel extension helper.
 * Searches common install and Homebrew Cask paths for `macfuse.fs.tgz` and reports
 * specific failures; a generic “You need to be root” from other tooling is often
 * not the actual cause of configure problems.
 */
const fs = require('fs')
