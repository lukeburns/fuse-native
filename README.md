...
On Darwin, these methods are provided by `fuse-shared-library`'s Darwin package.
The configure flow supports modern macFUSE locations (including Homebrew paths)
and reports concrete command errors.
